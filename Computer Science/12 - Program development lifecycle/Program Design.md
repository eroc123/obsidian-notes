**Structure chart** ;; a modelling tool used to decompose a problem into a set of sub-tasks. Shows hierarchy or structure of the different models and how they connect with each other.
